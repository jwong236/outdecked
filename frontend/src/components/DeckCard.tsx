            ...
            <div className="flex gap-1">
              {isInDeck ? (
                <button
                  ...
                  className="px-2 py-1.5 bg-red-600 text-white text-xs rounded hover:bg-red-700 transition-colors duration-150"
                >
                  Remove
                </button>
              ) : (
                <button
                  ...
                  className="px-2 py-1.5 bg-green-600 text-white text-xs rounded hover:bg-green-700 transition-colors duration-150"
                >
                  Add to Deck
                </button>
              )}
